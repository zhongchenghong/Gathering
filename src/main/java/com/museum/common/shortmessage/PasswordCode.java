...
public class PasswordCode {
    ...
    //短信模板ID
    private static final String TEMPLATEID="19484725";
    ...
    public static void  sendCode(String MOBILES,String username,String password) throws IOException {
        //生成6位随机数
        ...
        nvps.add(new BasicNameValuePair("params", "["+username+","+password+"]"));
