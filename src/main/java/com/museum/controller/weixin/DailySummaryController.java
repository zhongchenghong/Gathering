...
public class DailySummaryController {
    ...
    public Result getupstreammsg(String begin_date,String end_date){
        ...
        HttpRequest rq= new HttpRequest();
        String sr=HttpRequest.sendPost2("https://api.weixin.qq.com/datacube/getweanalysisappiddailysummarytrend?access_token="+str, param);
        return ResultUtil.success(sr);

    }
    //日趋势
    @ApiOperation(value = "日趋势")
    @PostMapping(value = "/getdailyvisittrend")
    public Result DailyVisitTrend(String begin_date,String end_date){
        String str =access_token();
        JSONObject jsonParam = new JSONObject();
        jsonParam.put("begin_date", begin_date);
        jsonParam.put("end_date", end_date);
