    ...
    public static void main(String[] args) throws Exception {
       // json();
        try {
            ...
            //测试获取实时天气1(包含风况，湿度)
            Map<String, Object> map = getTodayWeather1("101270101");
            ...
            //测试获取实时天气2(包含天气，温度范围)
            Map<String, Object> map2 = getTodayWeather2("101270101");
            System.out.println(map2.get("city") + "\t" + map2.get("temp1")
                    + "\t" + map2.get("temp2") + "\t" + map2.get("weather")
                    + "\t" + map2.get("ptime"));

            //测试获取一周天气  这个URL有点问题，返回不了数据，先注释掉
/*			List<Map<String, Object>> listData = getWeekWeatherMap("101270101");
